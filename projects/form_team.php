    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Tabel Team</li>
          <li class="breadcrumb-item active">Kelola Team</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              if(isset($_GET['kelola'])){
                ...
                if($_GET['kelola'] == 'tambah'){
                  ...
                  $devisi     ="";
                    ...
                    $query = mysqli_query($connect, "SELECT * FROM team WHERE id_team='".$_GET['id']."'");
            ...
            <div class="col">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  ...
                  <form action="../model/proses_team.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" value=<?= $_GET['kelola'] ?> name="kelola" />
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label fw-bold">Team ID</label>
                      <input type="text" class="form-control bg-dark-light" name="id_team" id="projectName" value=<?= $id_team ?> />
                      <div class="form-text"><span class="text-danger">*</span> Terisi otomatis</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label fw-bold fw-bold">Name</label>
                      <input type="text" class="form-control" name="nama" id="projectName" placeholder="Masukkan Nama Team" value='<?= $nama ?>' />
                    </div>
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label fw-bold fw-bold">Deskripsi</label>
                      <input type="text" class="form-control" name="deskripsi" id="projectName" placeholder="Deskripsi Anggota Team" value='<?= $deskripsi ?>' />
                    </div>
                    <!-- <div class="mb-3">
                    ...
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label fw-bold fw-bold">Instagram</label>
                      <input type="text" class="form-control" name="ig" id="projectName" placeholder="Masukkan username Instagram" value='<?= $ig ?>' />
                    </div>
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label fw-bold fw-bold">Devisi</label>
                      <select class="form-select" name="devisi" aria-label="Default select example">
                        <option selected disabled>Open this select menu</option>
                        <option value="Photographer" <?php if($devisi =="Photographer") echo 'selected'; ?>>Photographer</option>
                        <option value="Videographer" <?php if($devisi =="Videographer") echo 'selected'; ?>>Videographer</option>
                        <option value="Team" <?php if($devisi =="Team") echo 'selected'; ?>>Team</option>

                      </select>
                    </div>
                    <div class="mb-3">
                      <label for="fileInput" class="form-label fw-bold fw-bold">Unggah Gambar</label><br/>
                      <input type="file" class="form-control-file" name="img_file[]" accept=".jpg,.gif,.png,.webp"/>
                    </div>
                    <?php
                      if($_GET['kelola'] == 'edit'){
                    ?>
                      ...
                      <table class="table datatable">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><img style="width: 75px" src='<?php echo "../assets/img/team/".$id_team."/".$img; ?>' alt="<?= $id_team ?>"></td>
                            <td><?= $img ?></td>
                          </tr>
                          <?php } ?>
                        </tbody>
