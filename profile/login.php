        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              echo '
                <div class="card w-100 h-100 bg-danger" style="text-transform: capitalize;">
                  <div class="card-body text-center pt-3 fw-bolder text-light">'.
                     $_GET["pesan"].'
                  </div>
                </div>'
              ?>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="../model/proses_login.php"  method="POST" enctype="multipart/form-data" novalidate>
