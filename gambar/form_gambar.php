...
<body>
  ...
  <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <!-- Projects -->
          <li class="nav-item">
            <a class="nav-link " href="./viewgambar.php">
              ...
              if(isset($_GET['kelola'])){
                ...
                if($_GET['kelola'] == 'tambah'){
                  $tempatgambar       ="";
                    ...
                    $query = mysqli_query($connect, "SELECT * FROM background WHERE id_gambar='".$_GET['id']."'");
            ...
            <div class="col">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <div class="row py-4">
                    <div class="col">
                      <h2 class="fw-bold mb-1" style="text-transform: capitalize;"><?= $_GET['kelola'] ?> Background</h2>
                  ...
                  <form action="../model/proses_gambar.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" value=<?= $_GET['kelola'] ?> name="kelola" />
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label fw-bold">ID Gambar</label>
                      <input type="text" class="form-control bg-dark-light" name="id_gambar" id="projectName" value=<?= $id_gambar ?> readonly/>
                      <div class="form-text"><span class="text-danger">*</span> Terisi otomatis</div>
                    </div>
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label fw-bold fw-bold">Tempat Gambar</label>
                      <select class="form-select" name="tempatgambar" aria-label="Default select example">
