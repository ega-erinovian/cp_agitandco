                ...
                <div class="card-body">
                  <div class="row align-items-center justify-content-between w-100">
                    ...
                    <div class="col-2 text-end p-0">
                      <form action="./form_gambar.php" method="get">
                        <input type="hidden" name="kelola" value="tambah"/>
                        <button type="submit" class="btn btn-success"><i class="bi bi-file-earmark-plus-fill"></i> Tambah</button>
                      </form>
                    </div>
                  </div>
                  <table class="table datatable">
                    ...
                    <tbody>
                      <?php 
                        $query = mysqli_query($connect, "SELECT * FROM background");
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row gap-2">
                            <div class="col-2">
                              <form action="./form_gambar.php" method="get">
                                <input type="hidden" name="id" value=<?= $id_gambar ?> />
